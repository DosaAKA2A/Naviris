...
contextBridge.exposeInMainWorld('cobalt', {
  ...
  espBloquea: (id, clave) => ipcRenderer.invoke('esp:bloquea', { id, clave }),
  espDesbloquea: (id, clave) => ipcRenderer.invoke('esp:desbloquea', { id, clave }),
  espDesbloqueados: () => ipcRenderer.invoke('esp:desbloqueados'),
